...
```
```{r}
lin_mod2 <- lm(`suicides/100k pop` ~ .-`gdp_per_capita ($)` - year,
                                         data = train)
...
```
```{r}
lin_mod3 <- lm(`suicides/100k pop` ~ .-`gdp_per_capita ($)` - year -sex,
                                         data = train)
...
lin_mod4 <- lm(`suicides/100k pop` ~ .-`HDI for year`-`gdp_per_capita ($)`-year -sex,
                                         data = train)
