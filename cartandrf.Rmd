...
# CART
cart_df = data.frame(labels = test_us$suicides.100k.pop, predictions = predcart_us)
set.seed(377)
...
# RF
rf_df = data.frame(labels = test_us$suicides.100k.pop, predictions = pred.best.rf_us_mtryTen)
set.seed(377)
...
# Boosting
boost_df = data.frame(labels = test_us$suicides.100k.pop, predictions = pred.boost < 0.5)
set.seed(377)
